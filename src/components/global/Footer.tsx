      ...
      <div className='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
        ...
        <div className='md:flex md:justify-between px-12'>
          ...
          <div className='grid grid-cols-2 gap-x-10'>
            <div className=''>
              <h2 className='mb-4 text-sm font-semibold text-gray-200 uppercase'>Resources</h2>
            ...
            <div>
              <h2 className='mb-4 text-sm font-semibold text-gray-200 uppercase '>Contact</h2>
              <ul className='text-gray-300 space-y-3 font-medium'>
                <li className=''>
        ...
        <p className='text-sm text-center text-gray-300 sm:text-center'>
